...
const ParentDashboard = () => {
  ...
  try {
    ...
    const response = await fetch('http://localhost:5500/api/notifications/unread-count', {
  ...
  const fetchUserData = async () => {
    try {
      const [profileRes, childrenRes] = await Promise.all([
        ...
        fetch("http://localhost:5500/api/users/children", {
          headers: tokenHeader(),
        }),
      ]);
  ...
  const fetchGoals = async () => {
    try {
      const res = await fetch("http://localhost:5500/api/parent/goals", {
        headers: tokenHeader(),
      });
      const data = await res.json();
  ...
  const fetchChildrenProgress = async () => {
    try {
      const res = await fetch(
        "http://localhost:5500/api/parent/children-progress",
        { headers: tokenHeader() }
      );
      const data = await res.json();
  ...
  const fetchChildrenChores = async () => {
    try {
      const res = await fetch(
        "http://localhost:5500/api/parent/children-chores",
        { headers: tokenHeader() }
      );
      const data = await res.json();
  ...
  const fetchChores = async () => {
    try {
      const res = await fetch("http://localhost:5500/api/chores", {
        headers: tokenHeader(),
      });
      const data = await res.json();
      if (data.success) {
  ...
  const fetchChoreRecommendations = async () => {
    try {
      const res = await fetch(
        "http://localhost:5500/api/chores/recommendations",
        { headers: tokenHeader() }
      );
      const data = await res.json();
  ...
  const handleApproveGoal = async (goalId) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:5500/api/goals/${goalId}/approve`,
        {
          method: "POST",
          headers: { Authorization: `Bearer ${token}` },
        }
 ...
 const handleApproveProgress = async (submissionId) => {
    try {
      const token = sessionStorage.getItem('app_token');
      const response = await fetch(`http://localhost:5500/api/progress/${submissionId}/approve`, {
        method: 'POST',
        headers: { 'Authorization': `Bearer ${token}` }
      });
...
const handleDeclineProgress = async (notificationId, goalTitle) => {
  try {
    ...
    const response = await fetch(
      `http://localhost:5500/api/progress/${notificationId}/decline`,
      {
        method: 'POST',
        headers: {
  ...
  reassigned_chore_ids: data.reassigned_chore_ids,
      ...
      await fetch(`http://localhost:5500/api/notifications`, {
        method: 'POST',
        headers: {
...
const handleLogout = async () => {
  ...
  const sendAudioToServer = async (audioBlob) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5500/api/ai/speech-to-text",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
...
const ChoreManagementTab = ({
  ...
  const handleSaveEdit = async () => {
    try {
      const res = await fetch(
        `http://localhost:5500/api/chores/${editingChore.id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json", ...tokenHeader() },
  ...
  const handleDelete = async (c) => {
    ...
    try {
      const res = await fetch(`http://localhost:5500/api/chores/${c.id}`, {
        method: "DELETE",
        headers: tokenHeader(),
      });
